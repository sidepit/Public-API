...
The canonical skill lives at **`skills/sidepit-trade/SKILL.md`** in this
repository. Read that file and follow it exactly — steps in order, STOP where
a check fails. This stub exists only so agent frameworks that scan
`.agents/skills/` discover the skill automatically; it intentionally carries
